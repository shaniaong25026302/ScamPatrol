...
(function () {
  ...
  const LOGO = '<img src="/img/scam-patrol-logo.jpg" class="logo-big pixel" alt="Scam Patrol HQ"/>';
  ...
  async function showOutcome(node) {
    ...
    out.innerHTML =
      ...
      '<a href="/hq" class="gw-btn gold" style="margin-top:.6rem">ENTER SCAM PATROL HQ ▸</a></div>';
    ...
    try {
      ...
      if (d.reward) {
        ...
        $("out-reward").innerHTML = '<a href="/auth/register">Create an account</a> to earn XP and climb the leaderboard.';
      } else if (d.already) {
